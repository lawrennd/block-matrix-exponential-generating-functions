...
\midrule
10 & $1.2 \times 10^{-15}$ & $3.4 \times 10^{-9}$ & $1.1 \times 10^{-11}$ \\
50 & $2.7 \times 10^{-15}$ & $5.2 \times 10^{-9}$ & $2.3 \times 10^{-11}$ \\
100 & $4.1 \times 10^{-15}$ & $8.7 \times 10^{-9}$ & $4.5 \times 10^{-11}$ \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
$g_{11}$ & 0.24506 & 0.24506 & 0.24501 \\
$g_{12}$ & 0.00321 & 0.00321 & 0.00319 \\
$g_{33}$ & 0.91203 & 0.91203 & 0.91198 \\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph{Quantum field theory.} Dyson~\cite{1949radiationdyson} introduced time-ordered exponentials, but the connection to block matrix structure appears not to have been emphasized in the literature. We show how Dyson's time-ordered products have a natural realization via block exponentials.
...
All code for the numerical experiments is available at:
\begin{center}
\url{https://github.com/username/block-exponentials}
\end{center}
The repository includes:
\begin{itemize}
\item Python implementations of all block constructions,
\item Jupyter notebooks reproducing all figures and tables,
\item A pip-installable package: \texttt{pip install block-frechet}.
\end{itemize}
